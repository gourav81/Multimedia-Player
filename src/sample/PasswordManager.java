   ...
   public class PasswordManager
    {
        ...
        private static  SecretKey createAndSaveSecretKey() throws Exception
        {
            ...
            FileWriter writer  =  new FileWriter("C:\\Users\\User\\IdeaProjects\\DreamWork\\src\\sample\\SecretKey.txt" , false);
        ...
        {
            try {
                FileReader reader = new FileReader("C:\\Users\\User\\IdeaProjects\\DreamWork\\src\\sample\\SecretKey.txt");
        ...
        {
            try {
                BufferedReader reader = new BufferedReader(new FileReader("C:\\Users\\User\\IdeaProjects\\DreamWork\\src\\sample\\UserName.txt"));
        ...
        private static void saveUserName(String userName) throws IOException
        {
            ...
            FileWriter writer = new FileWriter("C:\\Users\\User\\IdeaProjects\\DreamWork\\src\\sample\\UserName.txt" , false);
        ...
        {
            BufferedReader reader = new BufferedReader(new FileReader("C:\\Users\\User\\IdeaProjects\\DreamWork\\src\\sample\\Password.txt"));
        ...
        private static void  encryptAndSavePassword(String password) throws Exception
        {
            ...
            FileWriter writer = new FileWriter(new File("C:\\Users\\User\\IdeaProjects\\DreamWork\\src\\sample\\Password.txt") , false);
